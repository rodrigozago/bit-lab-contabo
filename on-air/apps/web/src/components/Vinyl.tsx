...
export default function Vinyl({ slot }: { slot: Slot | null }) {
  return (
    <div className="flex items-center gap-3 sm:gap-5">
      {/* horários flanqueando o disco, como na referência — fora do elemento que gira */}
      <span className="w-11 shrink-0 text-right text-sm tabular-nums text-muted">
        {slot ? fmtTime(slot.starts_at) : '--:--'}
      </span>
