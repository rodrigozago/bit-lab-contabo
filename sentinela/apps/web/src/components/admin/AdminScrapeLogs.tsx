...
import type { ScrapeRun, SourceStatus } from "@sentinela/shared";
...
export function AdminScrapeLogs() {
  ...
  if (loading) {
    return (
      <BaseLayout title="Log de execuções">
        <div className="px-4 lg:px-6 text-sm text-muted-foreground">Carregando...</div>
      </BaseLayout>
    );
  }

  return (
    <BaseLayout title="Log de execuções" description="Status por fonte e histórico de execuções dos workers.">
