...
// O slug do app (client_id OIDC, ex: "bordado-digital", "face-lab") não é
// igual ao subdomínio de verdade (nginx: bordado.digital, face.bit-lab.tech) —
...
// bordado-digital manda pra "/app"; face-lab não tem uma rota única, então
